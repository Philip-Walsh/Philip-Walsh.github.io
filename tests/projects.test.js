...
describe("Projects Module", () => {
  ...
  it("should load projects and render them to the page", () => {
    ...
    expect(windSurfProject.querySelector("h3").textContent).toBe(
      "WindSurfRules",
    );
    expect(
      windSurfProject.querySelector(".project-technologies").innerHTML,
    ).toContain("JavaScript");
    expect(
      windSurfProject.querySelector(".project-links a").getAttribute("href"),
    ).toBe("https://github.com/Philip-Walsh/windSurfRules");
  });
  ...
  it("should handle missing project list element", () => {
    ...
    expect(console.error).toHaveBeenCalledWith(
      "Project list element not found",
    );
  });
